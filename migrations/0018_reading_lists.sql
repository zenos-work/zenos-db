-- 0018_reading_lists.sql — Named bookmark collections + count sync triggers
-- (merged: 0045)
...
-- Triggers: keep article_count in sync
...
INSERT INTO _migrations (filename) VALUES ('0018_reading_lists.sql');
