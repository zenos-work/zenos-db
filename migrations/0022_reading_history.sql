-- 0022_reading_history.sql — Per-user reading progress
-- (merged: 0038 + composite indexes from 0052)
...
INSERT INTO _migrations (filename) VALUES ('0022_reading_history.sql');
